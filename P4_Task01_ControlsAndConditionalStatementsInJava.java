...
class Statements {
    ...
    void LoopStatements() {
        ...
        System.out.println("The sum of first n natural number is" + sum); // concatenation is done to print the value of
                                                                          // sum along with the written statement
    ...
    void JumpStatements() {
        ...
        // Continue statement will exclude/skip the conditional value and rest of the
        // values are printed
        for (int i = 0; i <= 10; i++) {
            System.out.println(i);
            if (i == 6) {
